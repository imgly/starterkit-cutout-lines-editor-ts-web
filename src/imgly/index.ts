...
export async function initCutoutLinesEditor(cesdk: CreativeEditorSDK) {
  ...
  // Cutouts are primarily used for PDF export (print-ready die-cut lines)
  ...
  await cesdk.loadFromURL(
    'https://img.ly/showcases/cesdk/cases/cutout-lines/example.scene'
  );
  ...
  // Zoom to fit the page after loading
